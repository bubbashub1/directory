    ...
    <section class="bh-notification-centre" aria-labelledby="bh-notification-title">
        ...
        <form method="post" class="bh-notification-form">
            ...
            <div class="bh-notification-channel">
                <span class="bh-notification-channel-icon">📲</span>
                <span class="bh-notification-copy"><strong>Push notifications</strong><small><?php echo $push_ready ? 'Get selected Bubba Hub alerts directly on your installed phone/tablet app.' : 'Push is ready in the plugin but needs Firebase to be configured by the site administrator.'; ?></small></span>
                <?php if ( $push_ready ) : ?>
