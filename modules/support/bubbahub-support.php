...
add_action('wp_enqueue_scripts','bubbahub_support_assets.bh-support-hero{box-shadow:0 12px 35px rgba(0,0,0,.06)}.bh-support-topics{margin:38px 0}.bh-support-topic-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.bh-support-topic{border:1px solid #e5e7eb;border-radius:16px;background:#fff;padding:17px;text-align:left;font:inherit;font-weight:800;display:flex;justify-content:space-between;align-items:center;cursor:pointer;box-shadow:0 5px 16px rgba(0,0,0,.035);transition:.18s}.bh-support-topic:hover{transform:translateY(-2px);box-shadow:0 9px 22px rgba(0,0,0,.08)}.bh-support-success{padding:17px 20px;margin:0 0 20px;border-radius:15px;background:#edf9f0;border:1px solid #ccebd2}.bh-support-specialist-cta{display:flex;justify-content:space-between;align-items:center;gap:20px}.bh-support-optional{font-size:12px;font-weight:600;opacity:.6}.bh-support-app-card{padding:20px;border:1px solid #e5e7eb;border-radius:18px;background:#fff;box-shadow:0 5px 18px rgba(0,0,0,.035);display:flex;flex-direction:column;gap:13px}.bh-support-app-card div{display:flex;gap:8px;flex-wrap:wrap}.bh-support-app-card a{padding:8px 11px;border:1px solid #ddd;border-radius:9px;text-decoration:none;font-size:13px;font-weight:800}.bh-support-article-image{display:block;margin:-20px -20px 16px}.bh-support-article-image img{width:100%;height:160px;object-fit:cover;border-radius:16px 16px 0 0}.bh-support-text-link{font-weight:800;text-decoration:none}@media(max-width:900px){.bh-support-topic-grid{grid-template-columns:repeat(3,1fr)}}@media(max-width:650px){.bh-support-topic-grid{grid-template-columns:1fr}.bh-support-specialist-cta{align-items:flex-start;flex-direction:column}}');
