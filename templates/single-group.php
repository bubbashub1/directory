        ...
        <div class="bhg-shell">
            ...
            <div class="bhg-layout">
                ...
                <aside class="bhg-sidebar">
                    ...
                    <section class="bhg-sidebar-card bhg-ready"><?php if ( $booking_sessions ) : ?><div class="bhg-ready-icon" aria-hidden="true">✓</div><h2>Ready to Join?</h2><p>Secure your spot for this group right away.</p><a href="#bh-booking" class="bhg-book-button" data-booking-open>Book My Space Now <span>→</span></a><?php else : ?><div class="bhg-ready-icon bhg-ready-icon-text" aria-hidden="true">Ready to Join?</div><h2>No Bookings Available</h2><p>Sorry, no bookings are currently available. Please check the organiser's website for more information.</p><?php endif; ?></section>
                </aside>
            </div>
