...
function bubbahub_account_settings_stage2_shortcode() {
    ...
    <div id="bh-account-settings-screen" class="bh-profile-shell">
        ...
        <div id="bh-account-settings-list" class="bh-settings-list" role="navigation" aria-label="Account settings">
            <a class="bh-account-settings-item" href="<?php echo esc_url(add_query_arg(array('bh_account_settings'=>1,'bh_settings_section'=>'profile'))); ?>">
            ...
            <a class="bh-account-settings-item" href="<?php echo esc_url(add_query_arg(array('bh_account_settings'=>1,'bh_settings_section'=>'preferences'))); ?>"><span class="bh-account-settings-icon" aria-hidden="true">✨</span><span class="bh-account-settings-content"><h3>My Interests & Groups</h3><p>Choose interests from tags already used by Bubba Hub groups.</p></span><span class="bh-account-settings-arrow" aria-hidden="true">→</span></a>
            
             <a class="bh-account-settings-item" href="<?php echo esc_url(add_query_arg(array('bh_account_settings'=>1,'bh_settings_section'=>'family_needs'))); ?>"><span class="bh-account-settings-icon" aria-hidden="true">👨‍👩‍👧</span><span class="bh-account-settings-content"><h3>My Family &amp; Search Preferences</h3><p>Set family needs, preferred locations, days, times, age, session length, price and free-activity preferences.</p></span><span class="bh-account-settings-arrow" aria-hidden="true">→</span></a>
            ...
            <a class="bh-account-settings-item" href="<?php echo esc_url(add_query_arg(array('bh_account_settings'=>1,'bh_settings_section'=>'privacy'))); ?>"><span class="bh-account-settings-icon" aria-hidden="true">🔐</span><span class="bh-account-settings-content"><h3>Privacy & Security</h3><p>Open account security and submit data or deletion requests.</p></span><span class="bh-account-settings-arrow" aria-hidden="true">→</span></a>
            ...
            <a class="bh-account-settings-item" href="<?php echo esc_url(add_query_arg(array('bh_account_settings'=>1,'bh_settings_section'=>'consent'))); ?>"><span class="bh-account-settings-icon" aria-hidden="true">🛡️</span><span class="bh-account-settings-content"><h3>Class Consent & Safety</h3><p>Manage safety information, contact consent and media permissions.</p></span><span class="bh-account-settings-arrow" aria-hidden="true">→</span></a>
