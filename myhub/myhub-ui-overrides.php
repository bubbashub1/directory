...
function bubbahub_myhub_ui_overrides() {
    ...
    $css = '
        /* Use the active WordPress/theme typography throughout My Hub. */
        .bh-myhub,
        .bh-profile-shell,
        .bh-myhub button,
        .bh-myhub input,
        .bh-myhub select,
        .bh-myhub textarea,
        .bh-profile-shell button,
        .bh-profile-shell input,
        .bh-profile-shell select,
        .bh-profile-shell textarea {
            font-family: inherit;
        }

        /* Account settings should remain native/neutral rather than using the dark coloured header. */
        .bh-profile-shell .bh-profile-header.dark {
            background: var(--wp--preset--color--base, #fff) !important;
            color: inherit !important;
            border-color: #e6ebe9 !important;
            box-shadow: none !important;
        }
        .bh-profile-shell .bh-profile-header.dark p { color: inherit !important; }
        .bh-profile-shell .bh-profile-header.dark .bh-profile-kicker { color: inherit !important; }
        .bh-profile-shell .bh-profile-header.dark .bh-profile-back.light { color: inherit !important; }
        .bh-profile-shell .bh-pro-pill {
            color: inherit !important;
            border-color: #e6ebe9 !important;
        ...
        /* My Bookings page */
        .bh-my-bookings-page { max-width: 1100px; margin: 0 auto; padding: 24px 16px 70px; }
        .bh-my-bookings-page h1 { margin: 0 0 8px; }
        .bh-my-bookings-intro { margin: 0 0 24px; opacity: .78; }
        .bh-my-bookings-list { display: grid; gap: 14px; }
        .bh-my-booking { display: flex; justify-content: space-between; gap: 20px; align-items: center; padding: 20px; background: #fff; border: 1px solid #e6ebe9; border-radius: 18px; }
        .bh-my-booking-main { min-width: 0; }
        .bh-my-booking-title { margin: 0 0 5px; font-size: 18px; }
        .bh-my-booking-meta { margin: 0; font-size: 13px; line-height: 1.6; opacity: .78; }
        .bh-my-booking-status { display: inline-flex; margin-top: 9px; padding: 5px 9px; border-radius: 999px; background: #edf6f1; font-size: 11px; font-weight: 700; }
        .bh-my-booking-action { flex: 0 0 auto; }
        .bh-my-booking-action a { display: inline-flex; align-items: center; justify-content: center; min-height: 42px; padding: 9px 15px; border-radius: 11px; background: #f2f6f4; text-decoration: none; font-weight: 700; }
        .bh-my-bookings-empty { padding: 28px; border: 1px dashed #cfd8d3; border-radius: 18px; text-align: center; }
        .bh-my-bookings-login { padding: 28px; border: 1px solid #e6ebe9; border-radius: 18px; text-align: center; }
        @media (max-width: 620px) {
            .bh-my-bookings-page { padding-left: 12px; padding-right: 12px; }
            .bh-my-booking { display: block; }
            .bh-my-booking-action { margin-top: 14px; }
            .bh-my-booking-action a { width: 100%; }
        }
    ';
    wp_add_inline_style( 'bubbahub-myhub-ui-overrides', $css );
...
function bubbahub_my_bookings_shortcode() {
    if ( ! is_user_logged_in() ) {
        return '<div class="bh-my-bookings-page"><div class="bh-my-bookings-login"><h2>Please log in</h2><p>Log in to view your bookings.</p></div></div>';
    }
    ...
    <main class="bh-my-bookings-page">
        ...
        <?php if ( empty( $items ) ) : ?>
            <div class="bh-my-bookings-empty">
                <h2>No upcoming bookings</h2>
                <p>When you book a class or group, it will appear here.</p>
                <a href="<?php echo esc_url( home_url( '/directory/' ) ); ?>">Browse groups →</a>
            </div>
        <?php else : ?>
                ...
                <?php foreach ( $items as $booking ) :
                    ...
                    <article class="bh-my-booking">
                        <div class="bh-my-booking-main">
                            ...
                            <p class="bh-my-booking-meta">
                                <?php echo esc_html( $date_label ); ?><?php if ( $time_label ) : ?> · <?php echo esc_html( $time_label ); ?><?php endif; ?>
                                <?php if ( $booking['venue'] ) : ?> · <?php echo esc_html( $booking['venue'] ); ?><?php endif; ?>
                            </p>
                        ...
                        <div class="bh-my-booking-action">
                            <a href="<?php echo esc_url( $details_url ); ?>">View booking →</a>
                        </div>
                    </article>
                <?php endforeach; ?>
            </div>
