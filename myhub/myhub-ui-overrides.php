...
/* Account Settings card layout - authoritative override */
.bh-profile-shell .bh-account-grid{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:16px!important;width:100%!important;margin:0 0 20px!important;padding:0!important;align-items:stretch!important}
.bh-profile-shell .bh-account-grid > .bh-account-card{display:grid!important;grid-template-columns:34px minmax(0,1fr) 22px!important;grid-template-rows:auto!important;align-items:start!important;column-gap:12px!important;width:100%!important;min-width:0!important;min-height:122px!important;margin:0!important;padding:18px!important;box-sizing:border-box!important;overflow:hidden!important;background:#fff!important;border:1px solid #e6ebe9!important;border-radius:18px!important;box-shadow:0 2px 8px rgba(0,0,0,.025)!important;position:relative!important}
.bh-profile-shell .bh-account-grid > .bh-account-card > .bh-account-icon{grid-column:1!important;grid-row:1!important;display:flex!important;align-items:center!important;justify-content:center!important;width:34px!important;min-width:34px!important;height:34px!important;margin:0!important;padding:0!important;line-height:1!important;font-size:21px!important;flex:none!important}
...
.bh-profile-shell .bh-account-grid > .bh-account-card > .bh-account-card-body h3{display:block!important;width:auto!important;margin:1px 0 6px!important;padding:0!important;color:#1e3330!important;font-size:14px!important;font-weight:800!important;line-height:1.3!important;white-space:normal!important;overflow-wrap:anywhere!important}
.bh-profile-shell .bh-account-grid > .bh-account-card > .bh-account-card-body p{display:block!important;width:auto!important;margin:0!important;padding:0!important;color:#668785!important;font-size:11px!important;font-weight:500!important;line-height:1.5!important;white-space:normal!important;overflow-wrap:anywhere!important}
.bh-profile-shell .bh-account-grid > .bh-account-card > .bh-account-card-arrow{grid-column:3!important;grid-row:1!important;display:flex!important;align-items:center!important;justify-content:flex-end!important;width:22px!important;min-width:22px!important;height:34px!important;margin:0!important;padding:0!important;color:#668785!important;font-size:17px!important;line-height:1!important;font-weight:700!important}
.bh-profile-shell .bh-account-grid > .bh-account-card:hover{border-color:#b8ccc6!important;box-shadow:0 6px 18px rgba(30,51,48,.08)!important;transform:translateY(-1px)}
@media(max-width:950px){.bh-profile-shell .bh-account-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}}
@media(max-width:620px){.bh-profile-shell .bh-account-grid{grid-template-columns:1fr!important;gap:12px!important}.bh-profile-shell .bh-account-grid > .bh-account-card{min-height:96px!important;padding:15px!important;grid-template-columns:32px minmax(0,1fr) 20px!important;column-gap:10px!important}.bh-profile-shell .bh-account-grid > .bh-account-card > .bh-account-icon{width:32px!important;min-width:32px!important;height:32px!important}}
