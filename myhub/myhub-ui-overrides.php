...
function bubbahub_myhub_ui_overrides_stable() {
    ...
    $css = <<<'CSS'
.bh-profile-shell,.bh-profile-shell *{box-sizing:border-box}.bh-profile-shell{--bh-ui-text:var(--wp--preset--color--contrast,currentColor);--bh-ui-base:var(--wp--preset--color--base,#fff);--bh-ui-primary:var(--wp--preset--color--primary,var(--bh-ui-text));--bh-ui-border:color-mix(in srgb,var(--bh-ui-text) 16%,transparent);max-width:1100px;margin:0 auto;padding:24px 16px 70px;color:var(--bh-ui-text);font-family:inherit}.bh-profile-shell a{text-decoration:none!important}.bh-profile-shell .bh-profile-header{display:flex;justify-content:space-between;gap:24px;align-items:flex-start;background:var(--bh-ui-base)!important;color:var(--bh-ui-text)!important;border:1px solid var(--bh-ui-border);border-radius:24px;padding:28px;margin-bottom:20px;box-shadow:0 2px 10px rgba(0,0,0,.04)}.bh-profile-shell .bh-profile-header.dark{background:var(--bh-ui-primary)!important;color:var(--wp--preset--color--base,#fff)!important;border-color:var(--bh-ui-primary)!important}.bh-profile-shell .bh-profile-header.dark p{color:#a8c2bc!important}.bh-profile-shell .bh-profile-header p{color:color-mix(in srgb,var(--bh-ui-text) 65%,transparent)!important;font-size:13px;line-height:1.6}.bh-profile-shell .bh-profile-card{background:#fff;border:1px solid var(--bh-ui-border);border-radius:20px;padding:22px;margin-bottom:16px;box-shadow:0 2px 8px rgba(0,0,0,.025)}.bh-profile-shell .bh-profile-grid{display:grid!important;gap:16px!important;width:100%}.bh-profile-shell .bh-profile-grid.two{grid-template-columns:repeat(2,minmax(0,1fr))!important}.bh-profile-shell .bh-profile-grid.one{grid-template-columns:1fr!important}.bh-profile-shell .bh-profile-grid input,.bh-profile-shell .bh-profile-grid select,.bh-profile-shell .bh-profile-grid textarea{width:100%!important;max-width:100%!important;min-height:44px;border:1px solid var(--bh-ui-border)!important;border-radius:12px!important;background:var(--bh-ui-base)!important;padding:11px 13px!important;color:var(--bh-ui-text)!important}.bh-profile-shell input[type=file]{padding:9px!important;background:var(--wp--preset--color--secondary,var(--bh-ui-base))!important}.bh-myhub-avatar img{width:100%;height:100%;object-fit:cover;border-radius:inherit;display:block}.bh-myhub-child-specialist{font-weight:700}.bh-my-bookings-page{max-width:1100px;margin:0 auto;padding:24px 16px 70px}.bh-my-bookings-list{display:grid;gap:14px}.bh-my-booking{display:flex;justify-content:space-between;gap:20px;align-items:center;padding:20px;background:#fff;border:1px solid var(--bh-ui-border);border-radius:18px}.bh-my-booking-title{margin:0 0 5px;font-size:18px}.bh-my-booking-meta{margin:0;font-size:13px;line-height:1.6;opacity:.78}.bh-my-booking-status{display:inline-flex;margin-top:9px;padding:5px 9px;border-radius:999px;background:#edf6f1;font-size:11px;font-weight:700}.bh-my-booking-action a{display:inline-flex;align-items:center;justify-content:center;min-height:42px;padding:9px 15px;border-radius:11px;background:#f2f6f4}.bh-my-bookings-empty,.bh-my-bookings-login{padding:28px;border:1px solid var(--bh-ui-border);border-radius:18px;text-align:center}.bh-my-bookings-empty{border-style:dashed}@media(max-width:800px){.bh-profile-shell .bh-profile-grid.two{grid-template-columns:1fr!important}.bh-profile-shell .bh-profile-header{flex-direction:column}}@media(max-width:620px){.bh-my-booking{display:block}.bh-my-booking-action{margin-top:14px}.bh-my-booking-action a{width:100%}.bh-my-bookings-page{padding-left:12px;padding-right:12px}}@media(max-width:480px){.bh-profile-shell{padding:16px 10px 60px}.bh-profile-shell .bh-profile-header,.bh-profile-shell .bh-profile-card{padding:18px}}
CSS;
