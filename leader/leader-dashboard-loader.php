...
function bubbahub_leader_dashboard_register() {
    $renderer = '';
    if ( function_exists( 'bubbahub_leader_dashboard_shortcode' ) ) $renderer = 'bubbahub_leader_dashboard_shortcode';
    elseif ( function_exists( 'bubbahub_leader_dashboard_render' ) ) $renderer = 'bubbahub_leader_dashboard_render';
    if ( ! $renderer ) return;
