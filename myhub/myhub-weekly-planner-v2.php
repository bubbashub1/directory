...
.bh-planner-actions{display:flex;align-items:center;justify-content:center;gap:12px;margin:18px 0 0;padding:16px;border:1px solid #e6e6e6;border-radius:14px;background:#fff}.bh-planner-print-button,.bh-planner-subscribe-button{display:inline-flex;align-items:center;justify-content:center;padding:10px 16px;border:1px solid #ddd;border-radius:9px;background:#fff;font-weight:700;cursor:pointer;text-decoration:none!important;white-space:nowrap}.bh-planner-search{margin:0 0 18px;padding:14px 16px;border:1px solid #e6e6e6;border-radius:14px;background:#fff}
...
@media print{ @page{size:landscape;margin:8mm} body{margin:0!important;padding:0!important} body *{visibility:hidden!important}.bh-weekly-planner-v2,.bh-weekly-planner-v2 *{visibility:visible!important}.bh-weekly-planner-v2{position:absolute!important;left:0!important;top:0!important;width:100%!important;max-width:none!important;margin:0!important;padding:0!important;background:#fff!important;box-shadow:none!important}.bh-weekly-planner-v2>.bh-myhub-section-heading,.bh-planner-calendar-toolbar,.bh-planner-search,.bh-planner-actions,.bh-weekly-planner-preferences{display:none!important}.bh-planner-timetable-desktop{display:block!important;width:100%!important;max-width:none!important;overflow:visible!important;border:1px solid #999!important}.bh-timetable-body{min-width:0!important}.bh-timetable-header{min-width:0!important}.bh-timetable-event{break-inside:avoid}.bh-planner-mobile{display:none!important}}@media(max-width:700px){.bh-planner-actions{flex-direction:row;flex-wrap:wrap}.bh-planner-subscribe-button,.bh-planner-print-button{flex:1 1 0;min-width:0}.bh-planner-calendar-toolbar{grid-template-columns:1fr 1fr;}.bh-planner-calendar-toolbar strong{grid-column:1/-1;grid-row:1;order:-1;margin-bottom:4px}.bh-planner-calendar-toolbar a{ text-align:center }.bh-planner-search-location{max-width:none}.bh-timetable-header,.bh-timetable-body{min-width:0}.bh-planner-timetable-desktop{display:none}.bh-planner-mobile{display:block}}
</style>
<script>
